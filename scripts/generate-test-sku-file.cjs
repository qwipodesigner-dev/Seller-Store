...
const SKU_FIELDS = [
  ...
  { key: "packageType",              header: "Package Type",             mandatory: false, format: "Dropdown",
    options: [
      "Piece / Pieces (Pc/Pcs)","Pouch","Pack","Sachet","Bag","Lamination Bag","Bottle","Pet Bottle",
      "Jar","Pet Jar","Box","Tin","Can","Case","Tube","Tetra Pack","Sheet","Set","Pads","Refill",
      "Nons","Ladi","Bundle","Loose","Glass Jar","Plastic Jar","Container",
    ] },
  { key: "packageTypeValue",         header: "Package Type Value",       mandatory: false, format: "Positive number" },
...
const FIELD_RULES = {
  ...
  packageType:              "Optional. Pick the physical container the SKU ships in (Pouch, Bottle, Tin, etc.).",
  packageTypeValue:         "Optional. Numeric value paired with Package Type (e.g. 12 for a 12-bottle case). Decimals allowed.",
